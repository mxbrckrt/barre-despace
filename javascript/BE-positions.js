...
var background_rgb = [0, 0, 0, 1];
var handle_rgb = [0.278431, 0.839216, 1, 1];
var handle_inactive_rgb = [0.6, 0.6, 0.6, 1];
var label_rgb = [0.8, 0.8, 0.8, 0.8];
var marker_rgb = [0.5, 0.5, 0.5, 0.8];

// Labels

var pan_labels = [-1, "L", 0, "Cntr", 1, "R"];
var depth_labels = [-1, "-1", 0, "0", 1, "1"];
...
{    
    ...
    {                    
        ...
        var x1 = Math.round(pan2x(-1)) + 0.5;    
        var x2 = Math.round(pan2x(0)) + 0.5;
        var x3 = Math.round(pan2x(1)) + 0.5;
        var y1 = Math.round(depth2y(1)) + 0.5;
        var y2 = Math.round(depth2y(0)) + 0.5;
        var y3 = Math.round(depth2y(0)) + 0.5;
        ...
        for (i = 0; i < depth_labels.length / 2; i++)
        {
            ...
            move_to(x1 - measure[0] - 10, depth2y(depth_labels[2 * i]) + (measure[1]/2) * 0.73); 
